...
import 'package:multiplication_app/widgets/study_table/fun_fact_widget.dart';
import 'package:multiplication_app/widgets/study_table/multiplication_card.dart';
import 'package:multiplication_app/widgets/study_table/progress_indicator_widget.dart'; // Para localizaciones
          ...
          children: <Widget>[
            ...
            Expanded(
              child:
                  cards.isEmpty
                      ? const Center(
                        child: Text("No hay tarjetas para mostrar"),
                      )
                      : CardSwiper(
