...
import 'package:multiplication_app/widgets/quiz_result/card_result.dart';
import 'package:multiplication_app/widgets/quiz_result/confetti_animation.dart';
import 'package:multiplication_app/widgets/quiz_result/main_button.dart';
import 'package:multiplication_app/widgets/quiz_result/main_outline_button.dart'; // Importa el paquete de confeti
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor:
            result.passed ? Colors.green.shade600 : Colors.red.shade400,
                  ...
                  children: [
                    ...
                    Text(
                      result.passed
                          ...
                          : l10n
                              .quizFailedMessageLarge, // "¡OH NO! SIGUE INTENTANDO"
