...
import 'package:multiplication_app/screens/home_screen.dart';
...
import 'package:multiplication_app/screens/settings_screen.dart';
import 'package:multiplication_app/screens/stats_screen.dart';
import 'package:multiplication_app/screens/study_table_screen.dart';
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case RoutePaths.multiplicationSelection:
        ...
        if (arguments is String) {
          ...
          return MaterialPageRoute(
            builder:
                (context) =>
                    const HomeScreen(), // Volver a la selección
            settings: settings,
          );
        }
          ...
          return MaterialPageRoute(
            builder:
                (context) => ChangeNotifierProvider(
                  ...
                  create:
                      (_) => QuizNotifier(
                        context.read<QuizAttempProvider>(),
                        arguments,
                      ),
      ...
      case RoutePaths.study:
        ...
        if (arguments is int) {
          return MaterialPageRoute(
            builder: (context) => StudyTableScreen(args: StudyTableScreenArguments(tableNumber: arguments)),
            settings: settings,
          );
        } else {
          // Error: argumentos incorrectos
